...
const continentSize = 50; // How large the islands are (maintains water ratio, also determines island smoothness)

const growSeasonLength = 1200; // Grow season length (growSeasonLength * 2 / 30 = growSeasonLength in seconds)
const dieSeasonLength = 600; // Die season length (dieSeasonLength * 2 / 30 = dieSeasonLength in seconds)
...
const maxAcceleration = 1; // Maximum creature acceleration (TEMPORARILY DEPRECATED)
...
const rotationSpeed = 0.5; // Maximum rotation speed in radians per tick
...
const eatPower = 0.5; // Eating speed %
...
const minReproduceTime = 100; // Minimum number of ticks between spawns (minReproduceTime / 30 = minimum time between spawns in seconds)
...
const memories = 10; // # of memories a creature can store (outputs that do nothing, except store a value to be used as an input) — pretty expensive
